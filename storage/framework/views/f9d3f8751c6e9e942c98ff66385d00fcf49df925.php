<?php $__env->startSection('title', "Nossa História - ACMBV"); ?>
...
<section class="page-header"
    style="background: linear-gradient(rgba(40, 47, 16, 0.75), rgba(40, 47, 16, 0.75)),
           url('<?php echo e(asset('/site/img/bg-22.jpeg')); ?>') no-repeat center center;
            ...
            <div class="row align-items-stretch">
                <div class="col-lg-6 mb-5 mb-lg-0 d-flex">
                    <div class="sobre-pagina-galeria">
                        ...
                        <?php if(!empty($sobreNos->selo)): ?>
                            <div class="sobre-pagina-selo">
                                <?php echo nl2br(e($sobreNos->selo)); ?>

                            </div>
                        <?php endif; ?>

                        <div id="sobreNosCarousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="5000">
                            <?php if($galeria->count() > 1): ?>
                                <ol class="carousel-indicators sobre-pagina-indicadores">
                                    <?php $__currentLoopData = $galeria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li data-target="#sobreNosCarousel" data-slide-to="<?php echo e($index); ?>" class="<?php echo e($index === 0 ? 'active' : ''); ?>"></li>
                                ...
                                <?php $__currentLoopData = $galeria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                                        <div class="sobre-pagina-imagem-wrap">
                                            <img src="<?php echo e($slide->src); ?>" alt="<?php echo e($slide->alt); ?>" class="d-block w-100 sobre-pagina-imagem">
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                ...
                <div class="col-lg-6 pl-lg-5">
                    ...
                    <h2 class="sobre-pagina-titulo"><?php echo e($titulo); ?></h2>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3 d-flex">
                    <article class="sobre-integrante-card w-100">
                        <div class="sobre-integrante-foto-wrap">
                            ...
                            <img src="<?php echo e($integrante->fotoUrl()); ?>" alt="<?php echo e($integrante->nome); ?>" class="sobre-integrante-foto">
                        </div>
                        <div class="sobre-integrante-conteudo">
                            <h3><?php echo e($integrante->nome); ?></h3>
                            <p><?php echo e($integrante->cargo); ?></p>
                        </div>
                    </article>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.site.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/fabtech/Documents/projects/acmbv/resources/views/site/sobre/sobre.blade.php ENDPATH**/ ?>