        ...
        <div class="sobre-home-shell">
            <div class="row align-items-stretch">
                <div class="col-lg-6 mb-5 mb-lg-0 d-flex flex-column">
                    ...
                    <h2 class="sobre-home-titulo"><?php echo e($titulo); ?></h2>

                    <p class="sobre-home-texto">
                        <?php echo \Illuminate\Support\Str::limit($descricaoBase, 360); ?>
                    ...
                    <div class="sobre-home-actions">
                        <a href="<?php echo e(route('sobre-nos')); ?>" class="btn sobre-home-btn">
                           Ver mais
                            ...
                            <?php if($galeria->count() > 1): ?>
                                <ol class="carousel-indicators sobre-home-indicadores">
                                    <?php $__currentLoopData = $galeria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li data-target="#sobreHomeCarousel" data-slide-to="<?php echo e($index); ?>" class="<?php echo e($index === 0 ? 'active' : ''); ?>"></li>
                                ...
                                <?php $__currentLoopData = $galeria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                                        <div class="sobre-home-imagem-wrap">
                                            <img src="<?php echo e($slide->src); ?>" alt="<?php echo e($slide->alt); ?>" class="d-block w-100 sobre-home-imagem">
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php /**PATH /Users/fabtech/Documents/projects/acmbv/resources/views/site/home/_sobre.blade.php ENDPATH**/ ?>